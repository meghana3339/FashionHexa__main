    ...
    public partial class Project : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NotiicationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Notiications", x => x.NotiicationId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserRatingsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRatings", x => x.UserRatingsId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Availability_ProductId",
                table: "Availability",
                column: "ProductId");
